...
class SearchBase(Stage, SearchConfig):
    ...
    def init_text(
        ...
        **kwargs: Any,
        ...
        text_statement = Text(query=query, path=path, score=score, fuzzy=fuzzy, synonyms=synonyms)
        ...
        **kwargs: Any,
        ...
        if isinstance(self.operator, Compound):
            self.operator.autocomplete(
                type=type, query=query, path=path, token_order=token_order, fuzzy=fuzzy, score=score
            )
    ...
    def equals(
        ...
        **kwargs: Any,
        ...
        if isinstance(self.operator, Compound):
            ...
            self.collector.operator.equals(type=type, path=path, value=value, score=score)
        else:
    ...
    def range(
        ...
        **kwargs: Any,
        ...
        if isinstance(self.operator, Compound):
            self.operator.range(type=type, path=path, gt=gt, lt=lt, gte=gte, lte=lte, score=score)
        elif self.collector and isinstance(self.collector.operator, Compound):
    ...
    def text(
        ...
        **kwargs: Any,
        ...
        if isinstance(self.operator, Compound):
            self.operator.text(
                type=type, query=query, path=path, fuzzy=fuzzy, score=score, synonyms=synonyms
            )
        elif self.collector and isinstance(self.collector.operator, Compound):
    ...
    def numeric(
        ...
        **kwargs,
        ...
        if isinstance(self.collector, Facet):
            self.collector.numeric(path=path, name=name, boundaries=boundaries, default=default)
        else:
    ...
    def date(
        ...
        **kwargs,
        ...
        if isinstance(self.collector, Facet):
            self.collector.date(path=path, name=name, boundaries=boundaries, default=default)
        else:
    ...
    def string(
        self, path: str, name: str | None = None, *, default: str | None = None, **kwargs
    ) -> Self:
        if isinstance(self.collector, Facet):
